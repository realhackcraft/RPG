...
public class Level {
    ...
    @JsonProperty("worldX")
    public void setWorldX(int value) { this.worldX = value; }

    @JsonProperty("worldY")
    public int getWorldY() { return worldY; }

    @JsonProperty("worldY")
    public void setWorldY(int value) { this.worldY = value; }
    ...
    public Object getLevelBgColor() { return levelBgColor; }

    @JsonProperty("bgColor")
    public void setLevelBgColor(Object value) { this.levelBgColor = value; }
    ...
    @JsonProperty("bgPos")
    public Object getLevelBgPos() { return levelBgPos; }

    @JsonProperty("bgPos")
    public void setLevelBgPos(Object value) { this.levelBgPos = value; }
    ...
    public Object getLayerInstances() { return layerInstances; }

    @JsonProperty("layerInstances")
    public void setLayerInstances(Object value) { this.layerInstances = value; }
